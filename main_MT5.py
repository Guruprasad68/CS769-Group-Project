...
from transformers import BertTokenizer, AutoTokenizer, XLMRobertaTokenizer, MT5EncoderModel, T5Tokenizer
...
bert = MT5EncoderModel.from_pretrained("google/mt5-small")

import torch.nn as nn
import torch.nn.functional as F
from torch.autograd import Variable
print('MT5 model downloaded')
