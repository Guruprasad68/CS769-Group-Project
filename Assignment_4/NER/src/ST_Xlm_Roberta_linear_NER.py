...
df.to_csv('/content/drive/MyDrive/CS769/hw4/769_Project_Assignment_4/Named-Entity-Recognition/data/pseudo_xlm_roberta_large_50k.csv',index=False)
# concatenating pseudo data to labeled data
pseudo_df=pd.read_csv('/content/drive/MyDrive/CS769/hw4/769_Project_Assignment_4/Named-Entity-Recognition/data/pseudo_xlm_roberta_large_50k.csv')
concat_df=pd.concat([train_df,pseudo_df],ignore_index=True)
concat_df.to_csv('/content/drive/MyDrive/CS769/hw4/769_Project_Assignment_4/Named-Entity-Recognition/data/concat_xlm_roberta_large_50k.csv',index=False)
