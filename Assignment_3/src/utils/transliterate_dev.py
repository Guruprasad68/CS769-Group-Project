...
import requests
word_list =[]
file_names = {'train': ['Hinglish_train_14k_split_conll.txt', 'hinglish_train_unt_text.txt'], 'val': ['Hinglish_dev_3k_split_conll.txt', 'hinglish_dev_unt_text.txt']}
fk = 'val'
f1 = open("/content/drive/My Drive/CS769/Semeval_2020_task9_data/Hinglish/" + file_names[fk][0], "r")#Hinglish_dev_3k_split_conll.txt","r")
f_label = open("/content/drive/My Drive/CS769/Semeval_2020_task9_data/Hinglish/Hinglish_test_labels.txt","r")
f = open("/content/drive/My Drive/CS769/BAKSA_IITK/data/" + file_names[fk][1],"a+")
...
import re
def remove_emojis(data): # from stackoveflow
    emoj = re.compile("["
...
while(line):
    ...
    if(line=="\n"):
        if(len(word_list)):
            ...
            str1 = ''.join(transliterated_word_list)
            ...
            if(count%1==0):
                ...
                if 'RT' in transliterated_sentence:
                  print('this ->', transliterated_sentence)
